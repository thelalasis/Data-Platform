...
class acmodels(models.Model):
    ...
    expanded_acmodels = models.CharField("系列号", max_length = 100)
...
class ac(models.Model):
    ...
    acmodels = models.ForeignKey(acmodels, related_name='ac_acmodels', on_delete = models.CASCADE)
...
class engine_info(models.Model):
    id = models.AutoField(primary_key = True)
    en_models = models.CharField("发动机型号", max_length = 100)
...
class fm(models.Model):
    id = models.AutoField(primary_key = True)
    acmodels = models.ForeignKey(acmodels, related_name='fm_acmodels', on_delete = models.CASCADE, default = 1)
